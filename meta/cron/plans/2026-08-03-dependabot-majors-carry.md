...
**Live refresh:** 2026-08-31 ~05:00 PT (Mon deps-weekly) — safe #16 combined lockfile; same 7 majors remain  
**Repo tip at refresh:** product squash `761d141` (#16); last safe product **#16**; majors still #3/#4/#6/#8/#9/#11/#12

## Scope (open PRs — live `gh pr list`)

| PR | Title | Class | Live (2026-08-31 ~05:00 PT) |
|----|-------|-------|------------------------------|
...
**Already done safe:** #5 `@xterm/addon-fit` 0.10→0.11; #10 `tsx` 4.23.1→4.23.5; #13 `postcss` 8.5.22→8.5.26; #14 `tsx` 4.23.5→4.23.12 + `ws` 8.21.1→8.21.3; **#15** `@xyflow/react` 12.11.2→12.11.3 + `nanoid` 3.3.17→3.3.18; **#16** `tsx` 4.23.12→4.23.13 + `@xyflow/react` 12.11.3→12.11.5 (2026-08-31).  
**merged_safe:** `[5, 10, 13, 14, 15, 16]` · `prefer_first: null` · light jobs = majors_only_carry only.  
**2026-08-31 note:** prod audit 0; full audit still 2 high extract-zip via electron only; force path electron **44.0.0** (was 43.4.1). Option E only — do not reopen closed Option A.
...
| **E — electron major for extract-zip** | Bump electron past vulnerable range (npm force path → **44.x** today, **44.0.0**) to clear GHSA-jmr9-qjv8-65gv / Dependabot alert #38 | **High** — desktop smoke required; never unattended `audit fix --force` |
